...
urlpatterns = [
    ...
    path('perfil/<int:conta_id>/', views.perfil_view, name='perfil'),
    path('criar_conta/', views.criar_conta_view, name='criar-conta'),
    path('atualizar_conta/<int:conta_id>/', views.atualizar_conta_view, name='atualizar-conta'),
    path('deletar_conta/<int:conta_id>/', views.deletar_conta_view, name='deletar-conta'),
    ...
    path('deletar_posto/<int:posto_id>/', views.deletar_posto_view, name='deletar-posto'),
    ...
    path('deletar_preco/<int:preco_id>/', views.deletar_preco_view, name='deletar-preco'),
    ...
    path('deletar_comodidade/<int:comodidade_id>/', views.deletar_comodidade_view, name='deletar-comodidade'),
]